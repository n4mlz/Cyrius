...
impl ArchPageTableAccess for crate::arch::x86_64::thread::AddressSpace {
    type PageTable<'a> =
    ...
    fn with_page_table<R>(
        &self,
        mut f: impl FnMut(&mut Self::PageTable<'_>, &mut Self::Allocator<'_>) -> R,
    ) -> R {
...
impl ArchLinuxElfPlatform for X86LinuxElfPlatform {
